...
const routes: Routes = [
	...
	{ path: 'auth', loadChildren: () => import('../app/views/pages/auth/auth.module').then(m => m.AuthModule) },
	{
		...
		children: [
			...
			{
				path: 'adminsetup',
				loadChildren: () => import('../app/views/pages/adminsetup/adminsetup.module').then(m => m.AdminsetupModule)
			},
			{
				path: 'attendance',
				loadChildren: () => import('../app/views/pages/attendance/attendance.module').then(m => m.AttendanceModule)
			},
			{
				path: 'Dashboard',
