...
import { CustomerloyalitycardComponent } from '../customerloyalitycard.component';

@Component({
	selector: 'kt-customerloyalitycardlist',
	templateUrl: './customerloyalitycardlist.component.html',
	styleUrls: ['./customerloyalitycardlist.component.scss']
})
export class CustomerloyalitycardlistComponent implements OnInit {
	...
	async AddNew() {
		...
		dialogconfig.data = {};
		this.dialog.open(CustomerloyalitycardComponent, dialogconfig);
	}
